  ...
  return (
    <div className="login">
        ...
        <input type="text" placeholder="Email" {...register("email",{required:true})}/>
					...
					<button onClick={() => setLogin(true)} type="submit" className="login-btn-login">Login</button> <br />
          ...
          <button onClick={()=> signInWithGoogle()} disabled={authing} type="submit" className="login-btn-create-acc sign-up"><AiOutlineGoogle size={45}/></button>
          </div>
          </div>
				</form>
			</div>
